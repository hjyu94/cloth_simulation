...
#        self.mu = wp.array(dtype=float, device=self.device, requires_grad=True)
        # self.a = wp.array(data=0.2, dtype=float, device=self.device, requires_grad=True)
        ...
        self.model.gravity = wp.vec3(0.0, -5.0, 0.0)
